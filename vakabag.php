...
<div class="container mt-3">
  <h2>Daftar Permohonan Yang Belum Divalidasi Kepala Bagian</h2>
  <?php
	$berwenang=['2','7'];
      ...
      <tr>
        ...
        <td> <a href="cetakspt.php?idSurat=<?php echo $r['idSurat'];?>" target="_blank" class="btn btn-success">🔎  Lihat</a> 
         <?php if (($r['ValidasiSPTKabag'] != '1') and ($r['ValidasiSPTSekwan'] !='1') and ($r['ValidasiSPTKetua'] != '1')) {
            ?><a href="persetujuankabag.php?idSurat=<?php echo $r['idSurat'];?>" class="btn btn-info" onclick="return confirm('Apakah anda setuju ?');">✅ Setuju</a>
            <?php } elseif(($r['ValidasiSPTKabag'] == '1') and ($r['ValidasiSPTSekwan'] != '1') and ($r['ValidasiSPTKetua'] != '1')) {
                echo '<b class="text-danger">Belum diparaf Sekwan dan Ketua Dewan</b>'; } elseif (($r['ValidasiSPTKabag'] == '1') and ($r['ValidasiSPTSekwan'] == '1') and ($r['ValidasiSPTKetua'] != '1')) {
                    echo '<b class="text-success">Belum disetujui Ketua Dewan</b>'; } else { echo '<b class="text-success">Sudah disetujui</b>'; } ?>
        </td>
      </tr>
      <?php 
