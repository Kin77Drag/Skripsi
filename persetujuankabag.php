...
if  (isset($_GET['idSurat'])) {
    ...
    $sql="UPDATE `headersurat` SET `WaktuPengesahanSPTKetua`= now(),`ValidasiSPTKabag`=1 WHERE `IdSurat`='".$idSurat."'";
    $q=mysqli_query($koneksi,$sql);
    if ($q){
        ?><div class="alert alert-success alert-dismissible">
        <button type="button" class="btn-close" data-bs-dismiss="alert" onclick="window.location.href='vakabag.php';"></button>
