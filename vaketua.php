...
<html lang="en">
<head>
  <title>Daftar Permohonan Yang Belum DiValidasi Oleh Ketua Dewan</title>
  <meta charset="utf-8">
...
<div class="container mt-3">
  <h2>Daftar Permohonan Yang Belum Divalidasi Ketua Dewan</h2>
  <?php
	$berwenang=['1','7'];
      ...
      <tr>
        ...
        <td> <a href="cetakspt.php?idSurat=<?php echo $r['idSurat'];?>" target="_blank" class="btn btn-success">🔎  Lihat</a> 
         <?php if (($r['ValidasiSPTKabag'] == '1') and ($r['ValidasiSPTSekwan'] == '1') and ($r['ValidasiSPTKetua'] != '1')) {
            ?><a href="persetujuanketua.php?idSurat=<?php echo $r['idSurat'];?>" class="btn btn-info" onclick="return confirm('Apakah anda setuju ?');">✅ Setuju</a>
            <?php } elseif(($r['ValidasiSPTKabag'] != '1') and ($r['ValidasiSPTSekwan'] != '1')) {
                echo '<b class="text-danger">Belum diparaf Kabag dan Sekwan</b>'; } elseif (($r['ValidasiSPTKabag']== '1') and ($r['ValidasiSPTSekwan'] !='1')) {
                    echo '<b class="text-danger">Belum diparaf Sekwan</b>';
                } else { echo '<b class="text-success">Sudah disetujui</b>'; } ?>
        </td>
      </tr>
      <?php 
